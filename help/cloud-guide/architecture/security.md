...
過去 24 時間の操作について、バックアップは 1 時間ごとに実行されます。 24 時間が経過すると、バックアップはAWS EBS Snapshot サービスを使用してスケジュールに保持されます。 [ リテンション・ポリシー ](pro-architecture.md#retention-policy) を参照してください。
